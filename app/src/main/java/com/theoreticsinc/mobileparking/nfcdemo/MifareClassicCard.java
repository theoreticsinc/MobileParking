...
public class MifareClassicCard extends Activity {
     ...
     */
    @SuppressLint("NewApi")
    public String writeCarCode(String carCode, int block, String key) {
        boolean isTrue;
        String string = "";
        try {
            if (block % 4 == 3) {
                string = getResources().getString(R.string.alert_auth_block);
                return string;
            }
            connect();
            ...
            if (isTrue) {
                ...
                string = getResources().getString(R.string.alert_auth_err);
            }
        } catch (Exception e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
            //string = getResources().getString(R.string.alert_write_err);
        } finally {
            try {
                colse();
            } catch (Exception e) {
    ...
    public String modifyPassword(int block, String newPassword, String key) {
        ...
        try {
            if (block % 4 != 3) {
                string = getResources()
                        .getString(R.string.alert_not_auth_block);
                return string;
            }
